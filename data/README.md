...
These files are committed so a book render never downloads data. Third-party
artifacts are **not** relicensed under the book's text or code licenses; see
`../THIRD_PARTY_NOTICES.md` for the applicable notices. The book-corpus snapshot is
first-party manuscript text and follows the repository's text license.

| File | Provenance | Local SHA-256 |
|---|---|---|
| `book-corpus-ch1-9.txt` | Chapters 1–9 at book commit `24ae3a6321ad901497776180b8e107490750adc9`, with executable Python cells and HTML comments removed, used by the matched character-language-model studies in Chapters 10 and 14. `scripts/build_book_corpus_snapshot.py` reproduces it from repository history and asserts its length and checksum. | `b0fc23a513e37e7bcd78da04a03877345f6ebc850b91dbae260656d9924fb299` |
