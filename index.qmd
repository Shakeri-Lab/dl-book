...
and teaching improvements. The current stable edition is **v1.1 (July 24, 2026)**; its
[archived release and PDF](https://github.com/Shakeri-Lab/dl-book/releases/tag/v1.1)
preserve a fixed version. The live site is a rolling post-v1.1 build.
...
Version 1.1. [https://shakeri-lab.github.io/dl-book/](https://shakeri-lab.github.io/dl-book/).
:::
...
is the stable page-reference target. The live book is a rolling post-v1.1 build and may
move page numbers while corrections and teaching improvements continue.
...
[`CITATION.cff`](https://github.com/Shakeri-Lab/dl-book/blob/v1.1/CITATION.cff).
:::
