...
lecture:^[The per-parameter denominator is RMSProp, which entered the canon not
through a paper but through Lecture 6e of Hinton's Coursera course — the Adam
paper cites the slide deck itself. Some load-bearing ideas in this field were
never formally published.] momentum (accumulate past gradients), per-parameter adaptive learning rates
