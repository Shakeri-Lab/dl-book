...
$Q$. Chapter 6 will make that difference visible.
...
:::: {.plan-code}
::: {.plan}
1. Put each method's loss record on the same logarithmic scale.
2. Contrast a direct solve with the two iterative trajectories.
:::
