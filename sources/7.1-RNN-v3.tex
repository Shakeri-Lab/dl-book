...
\begin{center}
\includegraphics[width = 0.6\linewidth]{Module 6-RNN/figs/truncated-bptt.pdf}\\

\textit{D2L Fig. 9.7.1 Comparing strategies for computing gradients in RNNs. From top to bottom: randomized truncation, regular truncation, and full computation}
\end{center}
