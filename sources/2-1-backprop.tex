...
% Omitted from the public source snapshot: textbook-derived framing removed to keep
% the book's independently licensed source boundary clear. See sources/README.md.
...
% Omitted from the public source snapshot: textbook-derived gradient-checking passage
% removed to keep the book's independently licensed source boundary clear.
...
% Textbook-derived exercises were omitted from the public source snapshot. The
% independently written chapter exercises live in chapters/part1/05-backpropagation.qmd.
...
% Provenance: this teaching implementation follows Andrej Karpathy's micrograd
% (https://github.com/karpathy/micrograd), MIT License. The upstream notice is
